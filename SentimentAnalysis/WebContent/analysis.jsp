<%@page import="com.sa.model.Tweets"%>
		...
		<div class="row">
			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class=" row">
						...
						List<Tweets> tweetsPositive = tDao.readPositive(u1.getEmail());
						List<Tweets> tweetsNegative = tDao.readNegative(u1.getEmail());
							if ( (tweetsPositive == null || tweetsPositive.size() == 0) && (tweetsNegative == null || tweetsNegative.size() == 0) )
							{
								%>
									<h4> No Tweets are Available at the moment</h4>
								<%
							}
							else
							{
										  ...
										  <div class="panel panel-default">
										    ...
										    <div id="collapseOne1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne1">
										      <div class="panel-body">
										        ...
										        <%
										        	if (tweetsPositive != null && tweetsPositive.size()>0) {
										        %>
										  ...
										  <div class="panel panel-default">
										    ...
										    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
										      <div class="panel-body">
										        ...
										        <%
										        	if (tweetsNegative != null && tweetsNegative.size()>0) {
										        %>
